...
The Event Trace extension introduces new memory-mapped registers for setting up read-only contigurations, dynamically selecting the trace events to trace, submodes of operation, hardware filters, and its running status.
